...
<div class="max-w-md mx-auto px-4 py-10">
    ...
    <h1 class="text-2xl font-extrabold text-navy-900 mt-3 mb-6">Edit Fasilitas</h1>
    ...
    <form method="POST" action="{{ route('admin.facilities.update', $facility) }}" class="bg-white border border-gray-100 rounded-2xl p-6 space-y-4">
        @csrf
        @method('PUT')
