...
<div id="search-sticky-wrap" class="md:sticky md:top-0 z-30">
    ...
    <section class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 -mt-8">
        ...
        <form id="search-form"
              action="{{ route('home') }}"
              method="GET"
              class="relative bg-white rounded-2xl border border-gray-200 shadow-lg p-3 flex flex-col md:flex-row items-stretch gap-3">
            ...
            <div class="flex-[1.35] min-w-0">
                ...
                <label class="block text-[12px] font-bold text-gray-900 mb-1.5 px-1">
                    Kota, tujuan, atau nama hotel
                </label>

                <div class="h-[48px] border border-gray-300 rounded-[10px] bg-white flex items-center px-3.5">

                    <svg class="w-5 h-5 text-gray-500 shrink-0 mr-2"
                         fill="none"
                         stroke="currentColor"
                         viewBox="0 0 24 24"
                         stroke-width="1.8">
                    ...
                    <input type="text"
                           ...
                           class="w-full bg-transparent outline-none text-[15px] sm:text-base font-medium text-gray-700 placeholder:text-gray-400 placeholder:font-normal">
            ...
            {{-- =========================================================
                 CHECK-IN / CHECK-OUT
                 ========================================================= --}}
            <div class="flex-1 min-w-0 relative" id="date-field">
                ...
                <button type="button"
                        id="date-trigger"
                        class="w-full h-[48px] border border-gray-300 rounded-[10px] bg-white flex items-center px-3.5 text-left focus:outline-none hover:border-gray-400 transition">
                    ...
                    <span id="date-display"
                          class="text-[15px] sm:text-base font-medium text-gray-700 truncate">
                ...
                {{-- =====================================================
                     ...
                     ===================================================== --}}
                <div id="date-panel"
                     class="hidden absolute left-0 md:left-auto md:right-0 top-full mt-2 z-30 bg-white rounded-xl shadow-xl border border-gray-200 p-4 w-[92vw] max-w-[640px]">

                    <div class="flex items-center justify-between mb-3">

                        <button type="button"
                                id="cal-prev"
                                class="w-8 h-8 rounded-full hover:bg-gray-100 text-gray-500 text-lg">
                            ‹
                        </button>
                        ...
                        <div class="flex-1 grid grid-cols-2 gap-4 text-center">
                            ...
                            <span id="cal-title-0"
                                  class="font-display font-bold text-gray-900 text-sm">
                            </span>
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        ...
                        <div id="cal-grid-0"
                             class="grid grid-cols-7 gap-y-1 text-center text-xs">
                        </div>
                    ...
                    <div class="flex items-center justify-between mt-4 pt-3 border-t border-gray-100">
                        ...
                        <button type="button"
                                id="date-reset"
                                class="text-sm font-semibold text-gray-500 hover:text-brand-blue px-3 py-2">
                            Reset
                        </button>

                        <button type="button"
                                id="date-apply"
                                class="bg-brand-blue hover:bg-blue-700 transition text-white text-sm font-semibold px-6 py-2 rounded-full">
                            Apply
                        </button>
            ...
            {{-- =========================================================
                 TAMU DAN KAMAR
                 ========================================================= --}}
            <div class="flex-1 min-w-0 relative" id="guest-field">
                ...
                <button type="button"
                        id="guest-trigger"
                        class="w-full h-[48px] border border-gray-300 rounded-[10px] bg-white flex items-center justify-between px-3.5 text-left hover:border-gray-400 transition focus:outline-none">

                    <span class="flex items-center gap-2 min-w-0">

                        <svg class="w-5 h-5 text-gray-500 shrink-0"
                             fill="none"
                             stroke="currentColor"
                             viewBox="0 0 24 24"
                             stroke-width="1.8">
                    ...
                    {{-- Circle dropdown --}}
                    <span class="w-6 h-6 rounded-full bg-blue-50 text-blue-500 flex items-center justify-center text-sm shrink-0 ml-2">
                        ↓
                    </span>
                ...
                {{-- =====================================================
                     ...
                     ===================================================== --}}
                <div id="guest-panel"
                     class="hidden absolute left-0 md:left-auto md:right-0 top-full mt-2 z-30 bg-white rounded-xl shadow-xl border border-gray-200 p-4 w-72">

                    @foreach ([['adults', 'Dewasa', 2, 1], ['children', 'Anak', 0, 0], ['rooms', 'Kamar', 1, 1]] as [$key, $label, $default, $min])
                        ...
                        <div class="flex items-center justify-between py-2.5 {{ !$loop->last ? 'border-b border-gray-100' : '' }}">
                            ...
                            <div class="flex items-center gap-3">
                                ...
                                <button type="button"
                                        ...
                                        data-action="dec"
                                        data-min="{{ $min }}"
                                        class="w-7 h-7 rounded-full border border-gray-300 text-gray-500 hover:border-brand-blue hover:text-brand-blue transition">
                                    −
                                </button>

                                <span id="{{ $key }}_value"
                                      class="w-4 text-center text-sm font-semibold text-gray-900">
                                    {{ $default }}
                                </span>
                    ...
                    <button type="button"
                            id="guest-done"
                            class="mt-3 w-full bg-brand-blue hover:bg-blue-700 transition text-white text-sm font-semibold px-6 py-2 rounded-full">
                        Selesai
                    </button>
            ...
            <div class="flex items-end">
                ...
                <button type="submit"
                        class="w-full md:w-[150px] h-[48px] shrink-0 bg-[#0095F6] hover:bg-[#0087E5] transition text-white font-bold text-[15px] rounded-full whitespace-nowrap flex items-center justify-center gap-2">
